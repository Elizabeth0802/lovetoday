...
Page({
  ...
  data: {
    ...
    rule: 'up',
    items: [
      { name: 'up', value: '高于理想温度提醒' ,checked:'ture'},
      { name: 'down', value: '低于理想温度提醒' },
    ]
  },
  ...
  send: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=%E5%8C%97%E4%BA%AC&output=json&ak=4qD19ETARIAalHV8MVVRlrCWe1iblqRn', //百度天气API
      header: {
  ...
  getDataFromOneNet: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.heclouds.com/devices/503150875/datapoints?datastream_id=Light,Temperature,Humidity&limit=15',
      header: {
        'content-type': 'application/json',
        'api-key': 'Oqxw2dLf54O3bCAS5cOHWjftuzg='
      },
      success: function (res) {
